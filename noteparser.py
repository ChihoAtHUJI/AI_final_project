...
BPM = 120
DICT = {'$':0, 'A':1, 'b':2, 'B':3, 'C':4, 'd':5, 'D':6, 'e':7, 'E':8, 'F':9, 'g':10, 'G':11, 'a':12} #create dictionary for each note and placement
...
def get_chord_wave(chord, dur=0.5):
    if chord[-1] == 'm':
        ...
        a=4;b=3
    data = []
    data.append(calculate_freq(chord[0], CHORD_OCT)); data.append(calculate_freq(chord[0], CHORD_OCT, a)); data.append(calculate_freq(chord[0], CHORD_OCT, a+b))
